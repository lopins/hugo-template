...
2. 在 `config.yml` 修改 `theme: "hugo-PaperMod"`

3. 在 `config.yml` 修改 `editPost: "https://github.com/lopins/hugo-template/tree/main/content"`

4. 进入 `themes/hugo-PaperMod` 在 `theme.yml` 中配置其他字段
